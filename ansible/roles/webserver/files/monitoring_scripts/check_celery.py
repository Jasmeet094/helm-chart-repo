...
if __name__ == '__main__':
    ...
    celery_call = subprocess.Popen('sudo -u mhc bash -c "source /home/mhc/mhc-venv/bin/activate; cd /home/mhc/mhc-backend; celery -A Backend status active 2>&1 |grep -v \'^\\[\'"',
                                    shell=True,
