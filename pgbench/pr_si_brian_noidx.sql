...
SELECT id AS partners_client_id FROM (
    SELECT id FROM brian.partners_client
) x ORDER BY RANDOM() LIMIT 1 \gset

SELECT id AS partners_standaloneformula_id FROM (
    SELECT id FROM brian.partners_standaloneformula LIMIT :maximum_offset
) x ORDER BY RANDOM() LIMIT 1 \gset

SELECT id AS partners_ruleclause_id FROM (
    SELECT id FROM brian.partners_ruleclause LIMIT :maximum_offset
) x ORDER BY RANDOM() LIMIT 1 \gset
